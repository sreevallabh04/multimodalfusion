...
def run_enhanced_fusion_training():
    """Run the enhanced fusion model training."""
    print("🚀 Starting Enhanced Fusion Model Training")
    print("=" * 60)
    
    # Find the latest RGB model
    rgb_model_path = find_latest_rgb_model()
    if rgb_model_path:
        print(f"✅ Found RGB model: {Path(rgb_model_path).name}")
    else:
        print("⚠️  No RGB model found, will train from scratch")
    ...
    print("✅ Advanced attention fusion with 16 heads")
    print("✅ Enhanced thermal simulation") 
    print("✅ Acoustic features included")
    print("✅ Progressive training (freeze → unfreeze)")
